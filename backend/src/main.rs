	...
	let out = rocket::build()
		...
		.mount(
			...
			routes![
				...
				routes::assets::icon_window,
				routes::assets::icon_shield,
				...
				routes::scouting::teams::get_teams_stat,
				...
				routes::scouting::matches::match_report_download,
				...
				routes::scouting::matches::schedule::upload_match_schedule,
				routes::scouting::matches::review::match_review,
				routes::scouting::matches::review::edit_match,
